...
<html xmlns="http://www.w3.org/1999/xhtml"
    ...
    <head>
        <link rel="stylesheet" type="text/css" href="completedorder.css"></link>
        ...
        <title>Order Completed - BH Bags</title>
    ...
    <body style = "background-image:  url(image/kuku.jpg)">
        ...
        <div class="reviews">
            <p  style="color:gold;font-family: Trebuchet MS, sans-serif;font-size:17px;">Payment Successful Order Completed</p><br><br> <a href="orders.php"><button class = "btn">View Order</button></a>
        </div><br><br><br><br>
