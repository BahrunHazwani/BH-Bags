...
if(isset($_POST['name']) && isset($_POST['price'])){
	...
	if(!isset($_FILES['image']))
		die(header('Location: add_menu_item.php?erro=Please add a file'));
	...
	$pdo->add_menu($name, $desc_n, $price, $class, $image_url);
...
<html xmlns="http://www.w3.org/1999/xhtml"
    ...
    <head>
        <link rel="stylesheet" type="text/css" href="additem.css"></link>
            ...
            <p class="msg_error" style="padding:5px;"><?php echo @$_GET['erro']; ?></p>
                ...
                <div class="my_form1">
                    <div>
                        ...
                        <input required minlength="3" name="name"  style= "width: 30%;padding: 12px 20px;margin: 8px 0;box-sizing: border-box: 1 px solid black;border: 1px solid black;background-color: #F5D0A9;font-weight: bold;font-size: 17px;" />
                    </div>
                    <div>
                        ...
                        <textarea required minlength="6" name="desc_n" style= "width: 30%;padding: 12px 20px;margin: 8px 0;box-sizing: border-box: 1 px solid black;border: 1px solid black;background-color: #F5D0A9;font-weight: bold;font-size: 17px;" ></textarea>
                    </div>
                    <div>
                        ...
                        <input type="number" step="0.01" required  name="price"  style= "width: 30%;padding: 12px 20px;margin: 8px 0;box-sizing: border-box: 1 px solid black;border: 1px solid black;background-color: #F5D0A9;font-weight: bold;font-size: 17px;" />
                    </div>
                    <div>
                        ...
                        <select required  name="class" style= "width: 30%;height: 30%;padding: 12px 20px;margin: 8px 0;box-sizing: border-box: 1 px solid black;border: 1px solid black;background-color: #F5D0A9;font-weight: bold;font-size: 17px;" ><option value=""></option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>
                    </div>
                    <div>
                        ...
                        <input  type="file" required  name="image" style= "width: 30%;padding: 12px 20px;margin: 8px 0;box-sizing: border-box: 1 px solid black;border: 1px solid black;background-color: #F5D0A9;font-weight: bold;font-size: 17px;" />
                    </div>
                    <div>
