...
$pdo = new mypdo();
$orders = $pdo->get_all("SELECT * FROM orders WHERE user_id = $uid ORDER BY order_id DESC");
...
<html xmlns="http://www.w3.org/1999/xhtml"
    ...
    <head>
        <link rel="stylesheet" type="text/css" href="orders.css"></link>
     ...
     <body style = "background-image:  url(image/kuku.jpg)">
       ...
       <div class="title" id="title">
        ...
        <div class="small-container cart-page">
            <table class = "table_m">
                <tr>
                    <th style = "background-color:#A04000;font-family: Trebuchet MS, sans-serif;">View Bag</th>
                    <th style = "background-color:#A04000;font-family: Trebuchet MS, sans-serif;">Full Name</th>
                    <th style = "background-color:#A04000;font-family: Trebuchet MS, sans-serif;">Email</th>
                    <th style = "background-color:#A04000;font-family: Trebuchet MS, sans-serif;">Billing address</th>
                    <th style = "background-color:#A04000;font-family: Trebuchet MS, sans-serif;">Total Amount</th>
                    <th style = "background-color:#A04000;font-family: Trebuchet MS, sans-serif;">Date</th>
                </tr>
                <?php 
                ...
                <tr>
                    ...
                    <td style = "background-color:#E59866;font-family: Trebuchet MS, sans-serif;"><?php echo $order['fname']; ?></td>
                    <td style = "background-color:#E59866;font-family: Trebuchet MS, sans-serif;"><?php echo $order['email']; ?></td>
                    <td style = "background-color:#E59866;font-family: Trebuchet MS, sans-serif;">
                    <?php echo $order['billing_details']; ?>
                    </td>
                    <td style = "background-color:#E59866;font-family: Trebuchet MS, sans-serif;">RM<?php echo $order['amount']; ?></td>
                    <td style = "background-color:#E59866;font-family: Trebuchet MS, sans-serif;"><?php echo $order['date']; ?></td>
                </tr>
                <?php } 
				?>
         ...
         <p style="text-align:center; padding:100px 40px; font-size:24px;"> You have not made any order</p>
