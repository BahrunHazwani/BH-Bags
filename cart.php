                ...
                <tr class="menu_item" data-id="<?php echo $menu['id']; ?>" id="menu_<?php echo $menu['id']; ?>">
                    <td style = "background-color:#E59866;font-family: Trebuchet MS, sans-serif;">
                        <div class="cart-info">
                            ...
                            <br><br>
                            <a href="" class="btn" onClick="remove_cart(event, <?php echo $menu['id']; ?>)">Remove</a>
                            </div>
                        </div>
                    </td>
                    <td style = "background-color:#E59866;font-family: Trebuchet MS, sans-serif;">RM <?php echo $menu['price']; ?></td>
                    <td style = "background-color:#E59866;font-family: Trebuchet MS, sans-serif;"><input type="number" min="1"  value="<?php echo $carts[$menu['id']]; ?>" data-price="<?php echo $menu['price']; ?>" onChange="set_new_price()" onKeyUp="set_new_price()"></td>
                    <td class="sub_price" style = "background-color:#E59866;font-family: Trebuchet MS, sans-serif;">RM <?php echo number_format($sub_price, 2); ?></td>
                </tr>
                <?php } 
        ...
        <div class="total-price">
            <table class = "table_m" style = "font-family: Trebuchet MS, sans-serif;">
                <tr>
                    ...
                    <td id="sub_total"  style="background-color:darkgray;">RM <?php echo  number_format($sub_total, 2); ?></td>
                </tr>
                <tr>
                    <td  style="background-color:#154360;color:white;">Tax <small> (5%) </small></td>
                    <td id="total_tax"  style="background-color:darkgray;">RM <?php echo number_format($total_tax, 2); ?></td>
                </tr>
                <tr>
                    <td  style="background-color:#154360;color:white;">Total</td>
                    <td style="background-color:darkgray;"><b id="all_total">RM <?php echo number_format($all_total, 2); ?></b></td>
                </tr>
            </table>
        </div>
        
        <div style="text-align:center" id="process_div"><a href="payment.php" class="payment_btn_1">Continue to Payment</a></div>
       
        <?php } else{?>
         
         <p style="font-family: Trebuchet MS, sans-serif;text-align:center; padding:100px 40px; font-size:24px;color:#E59866;font-weight: bold;"> You have no bag in cart</p>
